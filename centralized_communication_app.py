...
rad = st.sidebar.radio("please select services from the following:",
                       ["DASHBOARD", "PROJECT", "TRAINING", "REPORT", "EVENT", "FEEDBACK", "CSR"])
...
if rad == "EVENT":
    ...
    if rad == "NEW EVENT":
        ...
        EVENT_TYPE = st.selectbox("EVENT TYPE",
                                  ["Meeting", "Workshop", "New Product/ Service Launch", "Training", "Others"])
        ...
        DOCx = st.selectbox("Select the DOC",
                            ["", "BoB", "BPC", "BT", "CDCL", "DRUKAIR", "DGPC", "KIL", "SMCL", "NRDCL", "TTPL"])
...
if rad == "DASHBOARD":
    ...
    imga = Image.open("./bob.png")
    imgb = Image.open("./bpc.png")
    imgc = Image.open("./bt.png")
    imgd = Image.open("./cdcl.png")
    imge = Image.open("./drukair.png")
    imgf = Image.open("./dgpc.png")
    imgg = Image.open("./kil.png")
    imgh = Image.open("./smcl.png")
    imgi = Image.open("./nrdcl.png")
    imgj = Image.open("./ttpl.png")
...
if rad == "REPORT":
    ...
    imga = Image.open("./report6.jpg")
    imgb = Image.open("./report1.jpg")
    imgc = Image.open("./report5.jpg")
    imgd = Image.open("./report2.jpg")
    imge = Image.open("./report3.jpg")
    imgf = Image.open("./report4.jpg")
